// A palindrome is a word or phrase that reads the same backwords and forwards

// It can be built similar to reverse, except we need to return a boolean value.

// This is as simple as returning a triple quality heck against the original string

// If you wanted to expand the function to test an entire phrase, you can create a helper function that uses Regular Expressions and the replace method on a string to keep only the letters. If regular Expressions are not allowed, we can create an array of acceptable characters to use as a filter.
...
validCharacters.indexOf(character) >
-1
            ?
